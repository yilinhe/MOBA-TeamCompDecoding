...
Since we have already finished evaluation our first model using deep learning, our next step is building the second model and evaluate it using logistic regression and deep learning.

Given this new feature, our plan for rest of the semester is as following:

Nov 1 - Nov 15: build second model and run LR and deep learning on the data set.
