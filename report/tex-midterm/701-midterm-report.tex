...
Unlike the character ranking model where we make the independent assumption between player skills and game results. The group ranking model need to take more consideration into account. To give a full intuition on 
